...
\cvitem{}{I'm currently in my penultimate year majoring in Software Engineering (BE). I have a passion for programming and use it as a tool for bringing ideas into reality. 
Over the past summer holidays I have created a simple android application. I express an interest in mobile application development and would like to gain further experience in this type of field. I would also enjoy working on both front-end and back-end applications. I am also interested in graphic/media design and recently have expressed an interest in business and would like to learn more about the tricks of the trade.  
In the future I want to start up a business creating mobile applications, where both my design and programming abilities are recognized. }

% I'm currently in my penultimate year majoring in Software Engineering (BE). I have a passion for programming and use it as a tool for bringing ideas into reality. 
% Over the past summer holidays I have created a simple android application. I express an interest in mobile application development and would like to gain further experience in this type of field. I would also enjoy working on both front-end and back-end applications. I am also interested in graphic/media design and recently have expressed an interest in business and would like to learn more about the tricks of the trade.  
% In the future I want to start up a business creating mobile applications, where both my design and programming abilities are recognized.   

\section{Projects}
\cvitem{Slick}{}
\cvitem{Personal Website (Hai.World)}{Description}
\cvitem{Public Transport API}{Description}
\cvitem{Food Recommender System}{Description}
...
\cventry{2015--Present}{Co-Founder \& Chief Information Officer}{GoSlick}{Wellington}{}{General description no longer than 1--2 lines.\newline{}%
...
\cventry{2015--2016}{Student}{Victoria Entrepreneur Bootcamp}{Wellington}{}{Description line 1\newline{}Description line 2}
