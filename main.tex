...
\section{About Me}
\cvitem{}{
I recently completed a Bachelor of Engineering (BE) degree, majoring in Software Engineering with First Class Honours.
I am a passionate engineer looking to make a positive impact on the world and improve the quality of people's lives.
% I recently completed the Victoria Entrepreneur Bootcamp where I co-founded a company that is providing a solution to the physically restricted and the elderly to increase their independence and make their lives easier.
} 

\cvitem{}{I enjoy working on both front-end and back-end applications with a strong emphasis on best practices, OO design principles, design patterns, user experience, and reusability. Specifically, I would like to gain experience in mobile development as it is a tool for bringing my ideas into reality. I am dynamic and have an attention to detail which allows me to understand fundamental concepts and learn new skills rapidly.}
