...
\cventry{2014--2015}{Software Engineer Intern}{Solnet Solutions}{Wellington}{}{Software engineer working on an internal support system.
\begin{itemize}%
\item Front-end:
  \begin{itemize}
      \item Bug-fixing
...
\cventry{2014--2015}{Web Developer}{Energy Management Association of New Zealand}{Wellington}{}{Front-end developer implementing a web page in the CMS Drupal.
\begin{itemize}%
...
\cventry{2015--2016}{Participant}{Victoria Entrepreneur Bootcamp}{Wellington}{}{Learning about business and what it takes to become an entrepreneur.
\begin{itemize}%
\item Skills Learnt:
  \begin{itemize}%
...
\cventry{}{Java}{}{}{}{I have 4 years experience with Java academically and personally. Through personal and university projects I have gained a strong understanding of Object-oriented (OO) programming. I have a large collection of public Java projects on GitHub (\url{www.github.com/haiquangtran}). This includes implementation of machine-learning algorithms such as KNN, SVD, and personal projects etc.}
\cventry{}{Other languages, frameworks, and tools}{}{}{}{
I have experience working in a range of languages, technologies, and frameworks. These include the languages: SQL, JavaScript, HTML/CSS, Sass, C\#, C, Scala, Python, Ruby; Web frameworks: Ruby on Rails, AngularJS, D3, Jax-RS, JaxB, Drupal; Database frameworks: PostgreSQL, MongoDB, Cassandra; Testing frameworks: JUnit, Karma/Jasmine; Mobile Development: Android, Windows; Other: JSON, XML. Experience in these areas have taught me the fundamental concepts to quickly pick up new tools, languages, and frameworks.  }

% \section{Languages}
% \cvitem{}{Although I am language agnostic, I am always open to learning new concepts, programming languages, tools, and frameworks. }
% \cvitemwithcomment{Java}{4 years experience academically and personally}{Through personal and university projects I have gained a strong understanding of Object-oriented programming. I have a large collection of public Java projects on GitHub (www.github.com/haiquangtran).}
% \cvitemwithcomment{Java}{Skill level}{Comment}
% \cvitemwithcomment{Other}{Skill level}{}
% \cvitem{}{Other languages, technologies, and frameworks I have experience with are as follows; C\#, Objective-C, JavaScript, PHP, MySQL, PostgreSQL, Kinect, LeapMotion, LESS, OAuth 2.0, REST, Spring (Core, Beans, MVC), and Laravel.}
