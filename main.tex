...
\cventry{}{More Projects}{}{}{}{I am actively learning new skills and working on different projects. To see more projects, please visit my GitHub at \url{www.github.com/haiquangtran.}}
...
\cventry{2015 Dec -- Present}{Co-Founder \& Chief Information Officer}{GoSlick}{Wellington}{}{Software Engineer and Scrum Master. This involved organising the team using an agile approach utilizing tools such as Trello, as well as overseeing any software related activities.
\begin{itemize}%
\item Scrum Master:
  \begin{itemize}
...
\cventry{2015 Nov -- 2016 Feb}{Participant}{Victoria Entrepreneur Bootcamp}{Wellington}{}{Learning about business and what it takes to become an entrepreneur.
\begin{itemize}%
\item Skills Learnt:
  \begin{itemize}%
      \item Communication, networking, presentation skills, and pitching 
      \item Business skills in terms of strategy, monetization, the operations in a business etc. 
      \item Legal skills in terms of IP, stocks etc.
      \item Lean methodology
      \item Financial skills such as forecasting, cashflow etc.
  \end{itemize}
\end{itemize}}

\cventry{2014 Dec -- 2015 March}{Web Developer}{Energy Management Association of New Zealand}{Wellington}{}{Front-end developer implementing a web page in the CMS Drupal.
\begin{itemize}%
\item Drupal Developer:
  \begin{itemize}%
      \item Implementing the page \url{http://www.emanz.org.nz/energy-specialists}
      \item Drupal (PHP), Boostrap, HTML/CSS, XAMPP stack
  \end{itemize}
\item Other:
  \begin{itemize}%
     \item Emailing directly with the client and designer.
  \end{itemize} 
\end{itemize}}

\cventry{2014 Nov -- 2015 Feb}{Software Engineer Intern}{Solnet Solutions}{Wellington}{}{Software engineer working on an internal support system.
\begin{itemize}%
\item Front-end:
  \begin{itemize}
      \item Bug-fixing
      \item Unit testing and functional end to end tests in Karma/Jasmine
      \item Refactoring code in AngularJS
      \item JavaScript, HTML/CSS, Sass, Bootstrap, AngularJS
  \end{itemize}
\item Back-end:
  \begin{itemize}%
      \item Implementing a countdown timer in Java
      \item Queries in MongoDB
      \item Refactoring code
      \item Java, JAX-RS, JAXB, Tom Cat Server, RESTful API
  \end{itemize}
\item Other:
  \begin{itemize}%
     \item Implemented agile methodologies (Scrum/Kanban) such as daily stand-ups and self-organising through Trello.
  \end{itemize} 
\end{itemize}}

\cventry{2011 Jan -- 2013 March}{Casual Worker}{Kelly Services}{Wellington}{}{This involved doing manual labour work for external companies such as Resene and Imperial Tobacco.}
...
\section{Education}
\cventry{2012--2015}{Bachelor of Engineering (Hons)}{Victoria University}{Wellington}{\textit{First Class Honours}}{ Majoring in Software Engineering at Victoria University. \\ GPA of 8.1 in 2015 (equivalent to an A average). }  % arguments 3 to 6 can be left empty
